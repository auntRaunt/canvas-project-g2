    ...
    onMouseUp(coord,event){
        ...
        $('#textInput').css({"display":"block","transform":"translateY("+coord[1]+"px)translateX("+coord[0]+"px)", "padding":"0"});
        ...
        $('#textInput').css({'display': 'none',"transform":"translateY("+coord[1]+"px)translateX("+coord[0]+"px)", "padding":"0"})
